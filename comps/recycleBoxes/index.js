...
function dispDontRecycle(foregroundColour,idName,headerText){
  return '<h3 id="donttext" style="margin: 0 0 0 50px;font-family: sans-serif;color: rgb(255, 255, 255);font-size: 64px;height:15vh;text-align:center;">'+headerText+'</  h3><div id="'+idName+'div'+'" style ="display: flex;flex-direction: column;height: 60vh;width: 40vw;border-radius: 24px;align-self: auto;margin: auto;justify-content:center;background-color:'+foregroundColour+';z-index: 3;"></div>'
}
